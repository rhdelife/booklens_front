...
export default function FocusSoundFAB() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      {/* 확장 패널 */}
      {isOpen && (
        <div className="mb-3 p-4 rounded-2xl bg-white/95 dark:bg-gray-800/95 backdrop-blur-md shadow-2xl border border-gray-200/50 dark:border-gray-700/50 space-y-3 transition-all duration-200 animate-fade-in">
          {/* 사운드 선택 */}
          <div>
          ...
          <div>
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className="w-8 h-8 rounded-lg bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 text-gray-700 dark:text-gray-300 flex items-center justify-center transition-colors"
              ...
              <div className="flex-1 h-2 bg-gray-200 dark:bg-gray-700 rounded-full overflow-hidden">
                <div
                  className="h-full bg-gray-900 dark:bg-gray-100 transition-all duration-200"
      ...
      >
        {isActive ? (
          <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
            <path d="M9 4h2v16H9V4zm4 0h2v16h-2V4z" transform="translate(0.5, 0)" />
          </svg>
        ) : (
